...
<body>
    ...
    <div class="grid w-screen place-items-center mt-10">
        ...
        <a href="/extrasReport">
            <p class="mb-5 text-sm underline">Table shows the current Month's record by default (Click to clear custom search)</p>
        </a>
    </div>
        ...
        <div class="min-w-fit min-h-min bg-white flex items-center justify-center font-sans">
            <div class="max-w-max lg:w-5/6">
                <div class="bg-white shadow-md rounded my-6">
                    <form action="/searchExtra" method="post" class="mb-2">
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td class="py-1 px-2 text-center">
                                            <div class="flex item-center justify-center">
                                                ...
                                                <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                    <a href="/confirmDeletionExtras?id=<?= $records["id"] ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
