...
<body>
    ...
    <div class="grid w-screen place-items-center">
        <p class=" font-bold text-2xl text-pink-500 mt-5">Record</p>
        <a href="/recordOptions">
            <p class="mb-5 text-sm underline">(Click for Record Options)</p>
        </a>
        ...
        <div class="min-w-max">
            <form action="/record" method="post">
                ...
                <div class="mt-5">
                    <label for="date" name="date" class="block text-sm font-medium text-gray-700"></label>
                    <div class="relative mt-1 rounded-md shadow-sm">
                        <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
