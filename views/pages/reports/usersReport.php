...
<body>
    ...
    <div class="grid w-screen place-items-center mt-10">
        <p class=" font-bold text-2xl text-pink-500">Users Reports</p>
    </div>

    <!-- Form and then table start -->
            ...
            <div class="max-w-max lg:w-5/6">
                <div class="bg-white shadow-md rounded my-6">
                    <div class="mt-10 font-medium">
                        ...
                        <form action="/usersSearch" method="post" class="mb-2">
                            <?php if (!empty($users)) : ?>
                                <select id="user" name="user" class="h-full w-2/5 rounded-md border py-2 text-pink-500 focus:border-gray-500 focus:ring-gray-500 font-bold sm:text-sm" required>
