...
<body>
    ...
    <div class="grid w-screen place-items-center mt-10">
        <p class=" font-bold text-2xl text-pink-500">Reports</p>
        <a href="/recordsReport">
            <p class="mb-5 text-sm underline">(Click here to refresh)</p>
        </a>
    </div>
        ...
        <div class="min-w-fit min-h-min bg-white flex items-center justify-center font-sans">
            <div class="max-w-max lg:w-5/6">
                <div class="bg-white shadow-md rounded my-6">
                    ...
                    <form action="/searchRecords" method="gett" class="mb-2">
                        <select id="type" name="type" class="h-full w-1/4 rounded-md border py-2 text-pink-500 focus:border-gray-500 focus:ring-gray-500 font-bold sm:text-sm">
                        ...
                        <input type="date" name="fromdate" id="fromdate" class=" w-1/5 rounded-md border-gray-300 pl-5 pr-5 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm inline" placeholder="dd/mm/yyyy" required>
                        <span class="text-pink-500 font-medium">to</span>
                        <input type="date" name="todate" id="todate" class=" w-1/5 rounded-md border-gray-300 pl-5 pr-5 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm inline" placeholder="dd/mm/yyyy" required>
                        <div class="inline">
                            <button type="submit" name="submit" id="submit" class="text-white bg-pink-500 px-2 py-2 rounded-lg hover:bg-pink-400 focus:outline-non focus:ring focus:ring-pink-700 transform transition active:translate-y-0.5 inline font-bold" onclick="wait()">Search</button>
                        </div>
                    </form>
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-pink-500 text-white text-sm leading-normal">
                                ...
                                <th class="py-1 px-1 text-center">Amount</th>
                                <th class="py-1 px-1 text-center">Type</th>
                                <th class="py-1 px-1 text-center">Charge</th>
                                <th class="py-1 px-1 text-center">Type</th>
                            ...
                            <?php else : $num = 0 ?>
                                ...
                                <!-- <td class="py-1 px-2 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <a href="/deleteRecord?id=<?= $record["id"]; ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
